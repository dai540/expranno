...
If you also have a truth table, you can validate exact matches instead of
only coverage.
...
annotation fields to `rowData`, and appends sample-level Deconvolution or
Signature outputs to `colData`.
